...
export default function App() {
  ...
  const translations: any = {
    'Español': {
      ...
      aboutUmmah: 'Hecho con ❤️ para la Ummah',
      aboutRights: '© 2026 Deenly AI. Todos los derechos reservados.',
      ...
      plansFeaturesFree: ['Consultas básicas de IA', 'Buscador del Corán', 'Biblioteca de Suras', 'Historial de chats limitado', 'Respuestas estándar'],
      plansFeaturesPro: ['Consultas ilimitadas', 'Respuestas profundas y detalladas', 'Soporte prioritario 24/7', 'Historial de chats ilimitado', 'Acceso anticipado a nuevas funciones', 'Sin anuncios ni interrupciones'],
    ...
    'English': {
      ...
      aboutUmmah: 'Made with ❤️ for the Ummah',
      aboutRights: '© 2026 Deenly AI. All rights reserved.',
      ...
      plansFeaturesFree: ['Basic AI queries', 'Quran Search', 'Surah Library', 'Limited chat history', 'Standard responses'],
      plansFeaturesPro: ['Unlimited queries', 'Deep and detailed answers', '24/7 priority support', 'Unlimited chat history', 'Early access to new features', 'No ads or interruptions'],
    ...
    'Français': {
      ...
      aboutUmmah: 'Fait avec ❤️ pour la Ummah',
      aboutRights: '© 2026 Deenly AI. Tous droits réservés.',
      ...
      plansFeaturesFree: ['Requêtes IA de base', 'Recherche dans le Coran', 'Bibliothèque de Sourates', 'Historique des chats limité', 'Réponses standard'],
    ...
    'العربية': {
      ...
      aboutUmmah: 'صنع بـ ❤️ للأمة',
      aboutRights: '© 2026 Deenly AI. جميع الحقوق محفوظة.',
      ...
      plansFeaturesFree: ['استفسارات الذكاء الاصطناعي الأساسية', 'البحث في القرآن', 'مكتبة السور', 'سجل دردشة محدود', 'استجابات قياسية'],
    ...
    'Indonesian': {
      ...
      aboutUmmah: 'Dibuat dengan ❤️ untuk Ummah',
      aboutRights: '© 2026 Deenly AI. Hak cipta dilindungi undang-undang.',
      ...
      plansFeaturesFree: ['Kueri AI dasar', 'Pencarian Al-Quran', 'Perpustakaan Surah', 'Riwayat obrolan terbatas', 'Tanggapan standar'],
    ...
    'Deutsch': {
      ...
      aboutUmmah: 'Mit ❤️ für die Ummah gemacht',
      aboutRights: '© 2026 Deenly AI. Alle Rechte vorbehalten.',
      ...
      plansFeaturesFree: ['Grundlegende KI-Abfragen', 'Koran-Suche', 'Suren-Bibliothek', 'Begrenzter Chat-Verlauf', 'Standard-Antworten'],
